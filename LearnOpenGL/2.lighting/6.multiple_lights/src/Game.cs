...
public class Game
{
    ...
    public void Render()
    {
        ...
        /*
        Aqui, definimos todos os *uniforms* para os 5 ou 6 tipos de luzes que possuímos. Precisamos defini-los manualmente e indexar a estrutura `PointLight` correta no *array* para configurar cada variável *uniform*. Isso pode ser feito de uma maneira mais organizada — definindo os tipos de luz como classes e configurando seus valores nelas — ou utilizando uma abordagem de *uniforms* mais eficiente, como os *Uniform Buffer Objects*; no entanto, esse é um assunto que abordaremos no tutorial de "GLSL Avançado".
        */
