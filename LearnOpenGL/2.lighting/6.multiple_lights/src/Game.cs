...
public class Game
{
    ...
    private void OnRender(double deltaTime)
    {
        ...
        */
        ...
        // spotLight
        lightingShader.SetUniform("spotLight.position", _camera.Position);
        lightingShader.SetUniform("spotLight.direction", _camera.Front);
        ...
        lightingShader.SetUniform("spotLight.cutOff", MathF.Cos(MathHelper.DegressToRadians(12.5f)));
        lightingShader.SetUniform("spotLight.outerCutOff", MathF.Cos(MathHelper.DegressToRadians(15.0f)));
