...
public class Game
{
    ...
    public Game()
    {
        ...
        _lightingShader = new Shader(
            "res/Shaders/light_casters/vertex.glsl",
            "res/Shaders/light_casters/fragment.glsl"
        );
    ...
    public void Render()
    {
        ...
        _lightingShader.SetVec3("light.direction", -0.2f, -1.0f, -0.3f);
        ...
        // um objeto de lâmpada é estranho quando temos apenas uma luz direcional; não renderize o objeto de luz
