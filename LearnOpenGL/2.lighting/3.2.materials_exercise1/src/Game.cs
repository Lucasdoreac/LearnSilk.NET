...
public class Game
{
    ...
    public Game()
    {
        ...
        _lightingShader = new Shader(
            "res/Shaders/materials/vertex.glsl",
            "res/Shaders/materials/fragment.glsl"
        );
    ...
    public void Render()
    {
        ...
        // propriedades da luz
        _lightingShader.SetVec3("light.ambient", 1.0f, 1.0f, 1.0f); // observe que todas as cores de luz estão definidas com intensidade máxima
        _lightingShader.SetVec3("light.diffuse", 1.0f, 1.0f, 1.0f);
        _lightingShader.SetVec3("light.specular", 1.0f, 1.0f, 1.0f);

        // propriedades do material
        _lightingShader.SetVec3("material.ambient", 0.0f, 0.1f, 0.06f);
        _lightingShader.SetVec3("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
        _lightingShader.SetVec3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
