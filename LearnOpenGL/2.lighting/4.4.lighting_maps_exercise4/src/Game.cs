...
public class Game
{
    ...
    public Game()
    {
        ...
        _lightingShader = new Shader(
            "res/Shaders/lighting_maps/vertex.glsl",
            "res/Shaders/lighting_maps/fragment.glsl"
        );
        ...
        _emissionMap = LoadTexture("res/Textures/matrix.jpg");
    ...
    public void Render()
    {
        ...
        // vincular mapa de emissão
        _gl.ActiveTexture(TextureUnit.Texture2);
        _gl.BindTexture(TextureTarget.Texture2D, _emissionMap);
