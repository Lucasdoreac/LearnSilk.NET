...
public class Game
{
    ...
    private float _yaw = -90.0f; // O yaw é inicializado em -90,0 graus, uma vez que um yaw de 0,0 resulta em um vetor de direção apontando para a direita; portanto, inicialmente rotacionamos um pouco para a esquerda.
    private float _pitch = 0.0f;
    private float _lastX = (float)Screen.Width / 2.0f;
    private float _lastY = (float)Screen.Height / 2.0f;
    ...
    public void Update()
    {
        ...
        float xpos = Input.MousePositon.X;
        float ypos = Input.MousePositon.Y;
