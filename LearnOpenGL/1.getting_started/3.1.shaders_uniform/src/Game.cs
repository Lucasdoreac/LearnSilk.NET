...
public class Game
{
    ...
    public void Init()
    {
        ...
        // vincule o VAO (ele já estava vinculado, mas apenas para demonstrar): como temos apenas um único VAO, podemos simplesmente vinculá-lo antes de renderizar o respectivo triângulo; esta é outra abordagem.
        _gl.BindVertexArray(_vertexArrayObject);
    }
